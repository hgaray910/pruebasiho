...
Begin VB.Form frmBusquedaFacturasDirectasPrevias 
   ...
   End
End
Attribute VB_Name = "frmBusquedaFacturasDirectasPrevias"
...
Private Sub pCarga()
    ...
    vlstrsql = "SELECT CHRFOLIOFACTURA, DTMFECHAHORA, MNYTOTALFACTURA, CASE WHEN BITPESOS = 1 THEN 'Pesos' ELSE 'Dólares' END PESOS, MNYTIPOCAMBIO FROM PVFACTURA " & _
               ...
               "WHERE NOT VCHUUID IS NULL AND INTMOVPACIENTE = " & vlintmovpaciente & " AND CHRTIPOPACIENTE = '" & vlchrtipopaciente & "' AND CHRTIPOFACTURA = '" & vlchrtipofactura & "' AND CHRESTATUS = 'C' " & _
