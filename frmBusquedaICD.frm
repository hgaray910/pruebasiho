...
Begin VB.Form frmBusquedaICD 
   ...
   Caption         =   "Búsqueda de diagnósticos ICD"
   ClientHeight    =   7770
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10335
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSHierarchicalFlexGridLib.MSHFlexGrid grdDiagnosticos 
         ...
         Left            =   120
         TabIndex        =   1
         ToolTipText     =   "Lista de diagnósticos ICD"
         Top             =   705
         Width           =   9930
         _ExtentX        =   17515
         _ExtentY        =   12091
...
Public vgstrTipoICD As String 'Indica el tipo de código ICD que se consultará (US = Urgencia sentida, UR = Urgencia real)
...
Private Sub pLimpiaGrid()
    ...
    With grdDiagnosticos
        ...
        .FormatString = "|Código ICD|Descripción del diagnóstico|"
        
        .ColWidth(0) = 100
        .ColWidth(1) = 1400     'Código ICD
        .ColAlignment(1) = flexAlignLeftCenter
        .ColWidth(2) = 8300     'Descripción del diagnóstico
        .ColAlignment(2) = flexAlignLeftCenter
        .ColWidth(3) = 0        'Clave Diagnóstico
    End With
...
Sub PSuperBusqueda(strTipoICD As String)
    ...
    'Se especifica el query según el tipo de ICD
