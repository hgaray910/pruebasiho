...
Begin VB.Form frmRptAltasSocios 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Altas de socios"
   ClientHeight    =   2715
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   4965
   ...
   Begin VB.Frame fraReporte 
      ...
      Begin VB.Frame fraImprime 
         ...
         Begin VB.CommandButton cmdPreview 
            ...
            Left            =   80
            MaskColor       =   &H00FFFFFF&
            Picture         =   "frmRptAltasSocios.frx":0000
            Style           =   1  'Graphical
            TabIndex        =   5
         ...
         Begin VB.CommandButton cmdPrint 
            ...
            Left            =   580
            MaskColor       =   &H00FFFFFF&
            Picture         =   "frmRptAltasSocios.frx":0403
            Style           =   1  'Graphical
            TabIndex        =   6
   ...
   End
End
Attribute VB_Name = "frmRptAltasSocios"
...
On Error GoTo NotificaError
    ...
    pInstanciaReporte vgrptReporte, "rptAltasSocios.rpt"
    ...
    Set rsSocios = frsEjecuta_SP(strParametros, "Sp_SORPTALTAS")
    ...
    If rsSocios.RecordCount <> 0 Then
            ...
            pImprimeReporte vgrptReporte, rsSocios, IIf(vlstrTipo = "P", "P", "I"), "Altas de socios"
